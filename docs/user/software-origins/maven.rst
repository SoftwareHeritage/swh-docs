...
`Maven <https://maven.apache.org/>`__ is Java's main package manager. There are multiple
...
See the `Maven lister's documentation <https://gitlab.softwareheritage.org/swh/devel/swh-lister/-/blob/master/swh/lister/maven/README.md>`__
